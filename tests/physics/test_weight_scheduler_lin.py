...
from nos.physics import WeightSchedulerLinear
...
class TestWeightSchedulerLin:
    ...
    def test_pde_weight_correct(self):
        ...
        assert torch.allclose(weight[10:21], 1e-3 * (epochs[10:21] - 10.) / 10.)
    ...
    def test_forward_weight_correct(self):
        ...
        assert torch.allclose(weight[10:21, 1], 1e-3 * (epochs[10:21] - 10.) / 10.)
    ...
    def test_forward_float_weight_correct(self):
        ...
        assert torch.allclose(weight, torch.tensor([1., 5e-4]))
